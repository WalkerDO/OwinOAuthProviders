...
namespace Owin.Security.Providers.TenDuke
{
    ...
    /// </summary>
    public interface ITenDukeAuthenticationProvider
    {
        /// <summary>
        ...
        Task Authenticated(TenDukeAuthenticatedContext context);
        ...
        /// <returns>A <see cref="Task"/> representing the completed operation.</returns>
        Task ReturnEndpoint(TenDukeReturnEndpointContext context);
    }
}