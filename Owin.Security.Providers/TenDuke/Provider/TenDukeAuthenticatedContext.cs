...
namespace Owin.Security.Providers.TenDuke
{
    ...
    /// </summary>
    public class TenDukeAuthenticatedContext : BaseContext
    {
        /// <summary>
        ...
        public TenDukeAuthenticatedContext(IOwinContext context, JObject user, string accessToken)
            : base(context)
        {
            User = user;
            AccessToken = accessToken;

            Id = TryGetValue(user, "Profile_id");
            Name = TryGetValue(user, "Person_lastName");
            Email = TryGetValue(user, "EmailAddress_value");
        }
